                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 h-full">
                        ...
                        <div className="p-12 bg-[#ECDED2]">
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div>
                                    <label htmlFor="name" className="block text-sm font-medium text-[#9C6548] mb-1 select-none">Name</label>
                                    <input
                                        type="text"
                                        id="name"
                                        name="name"
                                ...
                                />
                                <div>
                                    <label htmlFor="email" className="block text-sm font-medium text-[#9C6548] mb-1 select-none">E-mail</label>
                                    <input
                                        type="email"
                                        id="email"
                                        name="email"
                                ...
                                <div>
                                    <label htmlFor="message" className="block text-sm font-medium text-[#9C6548] mb-1 select-none">Message</label>
                                    <textarea
                                        id="message"
                                        name="message"
                                ...
                                <div>
                                    <button
                                        type="submit"
                                        className="w-full bg-[#7B4939] text-[#ECDED2] font-bold py-3 px-6 rounded-lg hover:bg-[#6B3A2A] focus:outline-none focus:ring-2 focus:ring-[#9C6548] focus:ring-opacity-50 transition duration-300 ease-in-out flex items-center justify-center select-none"
                                    >
